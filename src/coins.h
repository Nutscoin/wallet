...
/** 
    ...
    ****Note - for NUTS we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of NUTS coming in to a transaction

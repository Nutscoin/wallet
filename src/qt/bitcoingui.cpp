                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NUTS Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NUTS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and NUTS: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NUTS Core"), this);
    aboutAction->setStatusTip(tr("Show information about NUTS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NUTS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NUTS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NUTS addresses"));
    ...
    openAction->setStatusTip(tr("Open a NUTS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NUTS Core help message to get a list with possible NUTS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NUTS Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NUTS network", "", count));
}
...
{
    QString strTitle = tr("NUTS Core"); // default title

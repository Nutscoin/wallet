...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NUTS features */
        {"NUTS", "masternode", &masternode, true, true, false},
        {"NUTS", "listmasternodes", &listmasternodes, true, true, false},
        {"NUTS", "getmasternodecount", &getmasternodecount, true, true, false},
        {"NUTS", "masternodeconnect", &masternodeconnect, true, true, false},
        {"NUTS", "masternodecurrent", &masternodecurrent, true, true, false},
        {"NUTS", "masternodedebug", &masternodedebug, true, true, false},
        {"NUTS", "startmasternode", &startmasternode, true, true, false},
        {"NUTS", "createmasternodekey", &createmasternodekey, true, true, false},
        {"NUTS", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"NUTS", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"NUTS", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"NUTS", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"NUTS", "getmasternodescores", &getmasternodescores, true, true, false},
        {"NUTS", "mnbudget", &mnbudget, true, true, false},
        {"NUTS", "preparebudget", &preparebudget, true, true, false},
        {"NUTS", "submitbudget", &submitbudget, true, true, false},
        {"NUTS", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"NUTS", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"NUTS", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"NUTS", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"NUTS", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"NUTS", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"NUTS", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"NUTS", "checkbudgets", &checkbudgets, true, true, false},
        {"NUTS", "mnsync", &mnsync, true, true, false},
        {"NUTS", "spork", &spork, true, true, false},
        {"NUTS", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"NUTS", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use NUTSd, or the -server option to NUTS-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> NUTS-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:31400/\n";
}

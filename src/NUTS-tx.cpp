...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NUTS Core NUTS-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  NUTS-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded NUTS transaction") + "\n" +
                               "  NUTS-tx [options] -create [commands]   " + _("Create hex-encoded NUTS transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded NUTS transaction

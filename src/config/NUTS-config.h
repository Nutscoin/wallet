/* src/config/NUTS-config.h.  Generated from NUTS-config.h.in by configure.  */
/* src/config/NUTS-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef NUTS_CONFIG_H

#define NUTS_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.nuts.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "NUTS Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "NUTS Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "NUTS"

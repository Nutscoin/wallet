...
#if defined(NDEBUG)
#error "NUTS cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 1) { nSubsidy = 3750000 * COIN;
    } else if (nHeight > 1 && nHeight <= 300) { nSubsidy = 20 * COIN;
    } else if (nHeight > 300     && nHeight < 105000) { nSubsidy = 20 * COIN;
    } else if (nHeight >= 105000 && nHeight < 210000) { nSubsidy = 18 * COIN;
    } else if (nHeight >= 210000 && nHeight < 315000) { nSubsidy = 14 * COIN;
    } else if (nHeight >= 315000 && nHeight < 420000) { nSubsidy = 10 * COIN;
    } else if (nHeight >= 420000 && nHeight < 525000) { nSubsidy = 8 * COIN;
    } else if (nHeight >= 525000 && nHeight < 630000) { nSubsidy = 6 * COIN;
    } else if (nHeight >= 630000 && nHeight < 735000) { nSubsidy = 4 * COIN;
    } else if (nHeight >= 735000 && nHeight < 840000) { nSubsidy = 3 * COIN;
    } else if (nHeight >= 840000 && nHeight < 945000) { nSubsidy = 2 * COIN;
    } else if (nHeight >= 945000 && nHeight < 1050000) { nSubsidy = 1 * COIN;
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    if (nHeight > 120 && nHeight < 105000) { ret = blockValue * 0.75;
    } else if (nHeight >= 105000 && nHeight<210000) { ret = blockValue * 0.70; 
    } else if (nHeight >= 210000 && nHeight<315000) { ret = blockValue * 0.675; 
    } else if (nHeight >= 315000 && nHeight<420000) { ret = blockValue * 0.65; 
    } else if (nHeight >= 420000 && nHeight<525000) { ret = blockValue * 0.625; 
    } else if (nHeight >= 525000 && nHeight<630000) { ret = blockValue * 0.60; 
    } else if (nHeight >= 630000 && nHeight<735000) { ret = blockValue * 0.575; 
    } else if (nHeight >= 735000 && nHeight<840000) { ret = blockValue * 0.55; 
    } else if (nHeight >= 840000 && nHeight<945000) { ret = blockValue * 0.525; 
    } else if (nHeight >= 945000 && nHeight<=1050000) { ret = blockValue * 0.50; 
    } else if (nHeight > 1050000) { ret = 0; 
    }

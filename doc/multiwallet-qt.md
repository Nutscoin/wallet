...
In order to support loading of multiple wallets in NUTS-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is NUTS.cpp.
...
Changes to NUTS.cpp
----------------------
NUTS.cpp is the entry point into NUTS-qt, and as such, will require some minor modifications to provide hooks for

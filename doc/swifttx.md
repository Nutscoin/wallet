...
This mechanism has been integrated into Bitcore-Node-NUTS which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/NUTS-Project/insight-api-NUTS#web-socket-api](https://github.com/NUTS-Project/insight-api-NUTS#web-socket-api) 
* API: [https://github.com/NUTS-Project/insight-api-NUTS#swifttx-transactions](https://github.com/NUTS-Project/insight-api-NUTS#swifttx-transactions) 
...
By default, the NUTS Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the NUTS Core daemon:
